...
export interface ApiJournalTagJournalTag extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Journal Tag';
    pluralName: 'journal-tags';
    singularName: 'journal-tag';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    journal_tag: Schema.Attribute.Relation<
      'manyToMany',
      'api::journal.journal'
    >;
    locale: Schema.Attribute.String;
...
export interface ApiJournalJournal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blockText: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    journal_tags: Schema.Attribute.Relation<
      'manyToMany',
      'api::journal-tag.journal-tag'
    >;
    locale: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::journal-tag.journal-tag': ApiJournalTagJournalTag;
